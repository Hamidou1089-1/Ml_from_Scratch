...
elastic_net::elastic_net(double lambda1, double lambda2, LossT base_loss): lambda1_(lambda1), lambda2_(lambda2), base_loss_(std::move(base_loss)) {}

double elastic_net::compute_loss(const Eigen::VectorXd& y_true, const Eigen::VectorXd& y_pred, const Eigen::VectorXd& current_weight) {
